...
namespace Logos.Input.Sdl3
{
    ...
    {
        public static void OnKeyboardAdded(int keyboardId)
        {
            SDL_Event e = default;
        ...
        public static void OnKeyboardRemoved(int keyboardId)
        {
            SDL_Event e = default;
        ...
        public static void OnKeyDown(int keyboardId, KeyCode key, bool isRepeat)
        {
            SDL_Event e = default;
        ...
        public static void OnKeyUp(int keyboardId, KeyCode key)
        {
            SDL_Event e = default;
        ...
        public static void OnMouseAdded(int mouseId)
        {
            SDL_Event e = default;
        ...
        public static void OnMouseRemoved(int mouseId)
        {
            SDL_Event e = default;
        ...
        public static void OnMouseButtonDown(int mouseId, MouseButton button)
        {
            SDL_Event e = default;
        ...
        public static void OnMouseButtonUp(int mouseId, MouseButton button)
        {
            SDL_Event e = default;
        ...
        public static void OnMouseMotion(int mouseId, float x, float y, float xrel, float yrel)
        {
            SDL_Event e = default;
        ...
        public static void OnMouseWheel(int mouseId, float x, float y)
        {
            SDL_Event e = default;
